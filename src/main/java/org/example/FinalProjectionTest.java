...
//        ));
        ...
        Operator movieScan = new ScanOperator(bufferManager, "movies.data", 1);
        Operator workedonScan = new ScanOperator(bufferManager, "workedon_temp.data", 1);
        ...
        Operator peopleScan = new ScanOperator(bufferManager, "people.data", 1);
