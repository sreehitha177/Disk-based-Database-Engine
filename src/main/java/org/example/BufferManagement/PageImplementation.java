...
import org.example.BTree.BTreePage;
...
public class PageImplementation implements Page {
    ...
    public static final byte DATA_PAGE = (byte) 0;
    public static final byte WORKEDON_PAGE = 'W';
    public static final byte PEOPLE_PAGE = 'P';
    public static final byte TEMP_PAGE = 'T';
