...
public class BNLJOperatorTest {
    public static void main(String[] args) {
        ...
        moviesPage.insertRow(new DataRow(pad("tt0000003", 9), pad("Movie C", 30)));
        ...
        Operator left = new ScanOperator(bufferManager, moviesFile);
        Operator right = new ScanOperator(bufferManager, tempFile);
